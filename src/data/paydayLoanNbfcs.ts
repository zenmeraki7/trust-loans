...
export function getPaydayNbfcProfile(slug: string): EntityProfileData | null {
  ...
  return {
    ...
    details: { legalName: nbfc.name, website: "", supportEmail: "", supportPhone: "", registeredAddress: "", registrationNumber: "", rbiRegistrationClaim: nbfc.name, sourceUrls: [], lastVerifiedAt: "", verificationConfidence: "low" },
